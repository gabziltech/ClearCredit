 ...
 */
public class GetBills extends AsyncTask<Object, String, String> {
    private Context mContext;
    ProgressDialog mProgress;
    private OnGettingBills mCallback;

    public GetBills(Context context, OnGettingBills listner) {
    ...
    protected String doInBackground(Object[] params) {
        if (!isCancelled()) {
            ...
            Integer CustomerID = (Integer) params[1];
            return getServerInfo(ShopID, CustomerID);
        } else
            return null;
    }
    ...
    protected void onPostExecute(String message) {
        //process message
        mProgress.dismiss();
        mCallback.OnGettingBills(message);
    }
    ...
    private String getServerInfo(int ShopID, int CustomerID) {
        String reply1 = "";
        URI uri = null;
        try {
            uri = new URI("http://gabretailprod.cloudapp.net:8080/BillDetails/retail/WebService/BillDetails");
