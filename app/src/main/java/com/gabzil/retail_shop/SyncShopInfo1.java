 ...
 */
public class SyncShopInfo1 extends AsyncTask<Object,String, String>
{
    ...
    public SyncShopInfo1(Context context, OnGettingSyncData listner) {
        try{
    ...
    private ProgressDialog CreateProgress() {
        ...
        try {
            ...
            String title = "Sync is in process";
