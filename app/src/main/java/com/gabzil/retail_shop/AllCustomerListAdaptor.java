 ...
 */
public class AllCustomerListAdaptor extends ArrayAdapter<CustomerDBEntities> {
    ...
    public AllCustomerListAdaptor(Activity activity, int customlist, ArrayList<CustomerDBEntities> subList,TaskEditComplete listner,
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        holder.cell.setText(contactnos.get(0).getMobileNo());
